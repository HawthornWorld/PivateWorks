<template>
    <div class="lottery-wrapper">
        ...
        <DetailMask :isDetailShow="isDetailShow" :detailData="detailData" :userLang="userLang" @popDetail="popDetail"></DetailMask>
        <PrizePop
...
<script>
    ...
    export default {
        ...
        methods: {
             ...
             */
            getPrizeList() {
                const getPrizeList = constants.serverSrc + "/lottery/common/getPrizeList";
                this.$axios
                    .post(getPrizeList, {
                        language_id: 1
                    })
...
<style lang="scss" scoped>
    ...
    .lottery-wrapper {
        ...
        .lottery-cnt {
            ...
            width: rem(652px);
            height: rem(562px);
            background: url(#{$base}/bg_awards_borderlights.png) center center no-repeat/100%;
